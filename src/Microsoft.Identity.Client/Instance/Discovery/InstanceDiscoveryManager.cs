...
namespace Microsoft.Identity.Client.Instance.Discovery
{
    internal class InstanceDiscoveryManager : IInstanceDiscoveryManager
    {
        ...
        private readonly ICoreLogger _logger; // TODO: needed?
        private readonly IHttpManager _httpManager;
        private readonly ITelemetryManager _telemetryManager;


        public InstanceDiscoveryManager(ICoreLogger logger, IHttpManager httpManager, ITelemetryManager telemetryManager, bool shouldClearCaches)
        {
